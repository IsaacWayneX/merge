    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gray-100 border-b border-gray-200 p-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold text-gray-900">Merchant order</h1>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-2 bg-gray-50 p-2 rounded-lg border border-gray-200">
                      ...
                      <span className="px-2 py-1 bg-indigo-600 text-white text-sm rounded font-medium">
                        {order.merchantId}
                      </span>
                    </div>
                    <div className="mt-2">
                      <select
                        value={order.status}
                        onChange={() => {}}
                        className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm text-gray-900 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                      >
          ...
          <div className="grid grid-cols-2 gap-6 p-6">
            <div>
              ...
              <button className="px-3 py-1 bg-indigo-600 text-white rounded-md text-sm mb-4 hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors duration-200">
                {order.sender.name}
              </button>

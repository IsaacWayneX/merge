        ...
        <div className="divide-y">
          {pendingDates.map((date) => (
            <div key={date.id} className="flex items-center justify-start p-6 gap-8">
              ...
              <button className="rounded-md bg-[#5E17EB] px-6 py-2 text-sm font-bold text-white hover:bg-[#4C11D1] transition-colors ml-auto">
                View details
              </button>
            </div>
          ))}
